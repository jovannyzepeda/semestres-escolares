...
class honorarios{
public:
     float subtotal,total,ingreso[12],gasto[12],ganancia_bruta,ganancia_neta,isr_pagar,
           iva_pagar,gastototal,ingresototal,porcentaje_referencial,montos_brutos[3],
           porcentajes_isr[3],iva_generado,isr_generado,retencion_isr,retencion_iva,isr
           ,gasto_iva;
...
void honorarios::resultados(){
            int gastototal,ingresototal;
                ...
                isr=calculo_isr(ganancia_bruta);
